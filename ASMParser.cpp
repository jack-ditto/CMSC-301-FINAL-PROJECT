  ...
  // checks syntactic correctness of file and creates a list of Instructions.
{
  ...
  if(myFormatCorrect){
    ...
    for(auto& line : initialInstructions){
      ...
      vector<string> instructionAndEncoding;
      instructionAndEncoding.push_back(line);
      instructionAndEncoding.push_back(i.getEncoding());

      addressInstruction[address] = instructionAndEncoding;
